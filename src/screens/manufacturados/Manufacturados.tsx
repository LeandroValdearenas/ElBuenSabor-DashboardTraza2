    ...
    const getManufacturadosRest = useCallback(async (categoriaId?: number) => {
        try {
          ...
          const datos: ArticuloManufacturado[] = busqueda 
            ? await articuloManufacturadoService.buscarXDenominacion(busqueda, Number(idsucursal)) 
            : await articuloManufacturadoService.buscarXSucursal(Number(idsucursal));
                    ...
                    <Table size="small" aria-label="purchases">
                      ...
                      <TableBody>
                        {row.stocksManufacturado?.map((stockManufacturado) => (
                          <TableRow key={stockManufacturado.id}>
                            <TableCell component="th" scope="row">
